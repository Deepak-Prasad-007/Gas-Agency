...
<html>
        <body>
            <span style="font-size:80%"><a href="Admin_Charges.php">Cylinder Charges</span></a><br><br>
           <span style="font-size:80%"><a href="Operator_Disconnect.php">Disconnect</span></a><br><br>
           <span style="font-size:80%"><a href="Operator_Incoming.php">Stock</span></a><br><br>
           <span style="font-size:80%"><a href="Admin_delivery_boy.php">Delivery Boy</span></a><br><br>           
</body>
</html>
              </p>            
            <p class="spec"></p>
